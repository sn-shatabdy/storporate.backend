...
namespace Storporate.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260921090439_AddSponsorshipRequests")]
    partial class AddSponsorshipRequests
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Storporate.SharedKernel.Entities.ClubProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("AudienceFieldsOfStudy")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("AudienceYears")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("Status", "University");

                    b.ToTable("ClubProfiles", (string)null);
                });
            ...
            modelBuilder.Entity("Storporate.SharedKernel.Entities.JobApplication", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("JobPostingId", "StudentAccountId")
                        .IsUnique();

                    b.ToTable("JobApplications", (string)null);
                });

            modelBuilder.Entity("Storporate.SharedKernel.Entities.JobPosting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Storporate.SharedKernel.Entities.OutreachConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OrganizationAccountId", "StudentAccountId")
                        .IsUnique();

                    b.ToTable("OutreachConversations", (string)null);
                });

            modelBuilder.Entity("Storporate.SharedKernel.Entities.OutreachMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("OutreachMessages", (string)null);
                });
            ...
            modelBuilder.Entity("Storporate.SharedKernel.Entities.PortfolioItem", b =>
                {
                    ...
                    b.Property<bool>("ShareOriginalWithEmployers")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Storporate.SharedKernel.Entities.ShortlistEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Storporate.SharedKernel.Entities.SponsorshipGoalSet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AudienceCities")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<string>("AudienceUniversities")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("SponsorshipGoalSets", (string)null);
                });

            modelBuilder.Entity("Storporate.SharedKernel.Entities.SponsorshipRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int?>("AgreedAmount")
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid>("ClubOwnerAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("CompanyOwnerAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ClubOwnerAccountId", "Status");

                    b.HasIndex("CompanyOwnerAccountId", "Status");

                    b.ToTable("SponsorshipRequests", (string)null);
                });

            modelBuilder.Entity("Storporate.SharedKernel.Entities.SponsorshipRequestMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SponsorshipRequestMessages", (string)null);
                });
            ...
            modelBuilder.Entity("Storporate.SharedKernel.Entities.ClubProfile", b =>
                {
                    b.HasOne("Storporate.SharedKernel.Entities.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("Storporate.SharedKernel.Entities.JobApplication", b =>
                {
                    b.HasOne("Storporate.SharedKernel.Entities.JobPosting", "JobPosting")
                        .WithMany()
                        .HasForeignKey("JobPostingId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Storporate.SharedKernel.Entities.User", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("Storporate.SharedKernel.Entities.OutreachConversation", b =>
                {
                    b.HasOne("Storporate.SharedKernel.Entities.User", "Organization")
                        .WithMany()
            ...
            modelBuilder.Entity("Storporate.SharedKernel.Entities.OutreachMessage", b =>
                {
                    b.HasOne("Storporate.SharedKernel.Entities.OutreachConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Storporate.SharedKernel.Entities.SponsorshipRequest", b =>
                {
                    b.HasOne("Storporate.SharedKernel.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("ClubOwnerAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Storporate.SharedKernel.Entities.ClubProfile", null)
                        .WithMany()
                    ...
                    b.HasOne("Storporate.SharedKernel.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("CompanyOwnerAccountId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Storporate.SharedKernel.Entities.SponsorshipGoalSet", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Storporate.SharedKernel.Entities.SponsorshipRequestMessage", b =>
                {
                    b.HasOne("Storporate.SharedKernel.Entities.SponsorshipRequest", "Request")
                        .WithMany("Messages")
