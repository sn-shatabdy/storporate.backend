    ...
    IOptions<JwtOptions> options) : IJwtTokenService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var accessToken = CreateAccessToken(user, jwtOptions, now, accessTokenExpiresAt);
    ...
    private static string CreateAccessToken(User user, JwtOptions jwtOptions, DateTime now, DateTime expiresAt)
    {
        Claim[] claims =
        [
